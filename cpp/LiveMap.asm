...
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	.SECTION LIVEMAP_C_10A0_13FF_LIM, CODE, LOCATE=H'13FF
...
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	;Baudrate
			...
			.SECTION LIVEMAP_C_D0D0, CODE, LOCATE=H'D0D0

				 mov     #h'3, r13                                  

		;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

			.SECTION LIVEMAP_C_D0F6, DATA, LOCATE=H'D0F6
		...
		;	.SECTION LIVEMAP_C_EC28, DATA, LOCATE=H'EC28

		;		.DATA.L		COPY                                    

		;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

			.SECTION LIVEMAP_C_D314, DATA, LOCATE=H'D314

				.DATA.L		___DMAOPFLAG		;	0xD316=0x84,0x80                               

		;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

			.SECTION LIVEMAP_C_D8D8, CODE, LOCATE=H'D8D8

				nop							;	0xD8D8=0,9                               

		;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

			.SECTION LIVEMAP_C_E5A2, DATA, LOCATE=H'E5A2

				.DATA.B		H'9A, H'6A		;	 mov.w   #h'70B, r10 ; 0XE5A2=0X9A,0X6A                              

		;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

			.SECTION LIVEMAP_C_E5E2, CODE, LOCATE=H'E5E2

				nop							;	0XE5E2=0,9                              

		;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

			.SECTION LIVEMAP_C_E60E, DATA, LOCATE=H'E60E

				.DATA.B		H'9A, H'34		;	 mov.w   #h'70B, r10 ; 0XE60E=0X9A,0X34                              

		;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

			.SECTION LIVEMAP_C_E64E, CODE, LOCATE=H'E64E

				nop							;	0XE64E=0,9                              

		;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

			.SECTION LIVEMAP_C_E67A, DATA, LOCATE=H'E67A
...
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	.SECTION LIVEMAP_C_138, DATA, LOCATE=H'138

		.DATA.L		DMAEND                                    

;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

	.SECTION LIVEMAP_C_324, DATA, LOCATE=H'324

		.DATA.L		RXI0                                    

;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

	.SECTION LIVEMAP_C_32C, DATA, LOCATE=H'32C
