...
;int_disable:	.DATA.L	H'400
;int_enable:		.DATA.L H'41E


;serialreceivewithoutdma:		.DATA.L H'e32a		;/*TO BE CHANGED FOR EACH ROM*/
;bit7allowslogging:				.DATA.L H'ffff6fea 	;/*TO BE CHANGED FOR EACH ROM*/
;mutorobd:						.DATA.L H'ffff6fb2 	;/*TO BE CHANGED FOR EACH ROM*/
;receive_transmit_status_bits:	.DATA.L H'ffff6fe6 	;/*TO BE CHANGED FOR EACH ROM*/
;mut_timeout:						.DATA.L H'ffff7054 	;/*TO BE CHANGED FOR EACH ROM*/
;SAR3:							.DATA.L H'ffffecf0
;DAR3:							.DATA.L H'ffffecf4
;DMATCR3:						.DATA.L H'ffffecf8
;CHCR3:							.DATA.L H'ffffecfc
;DMA3CONFIGread:					.DATA.L H'20105
;SSR0:							.DATA.L H'fffff004
;RDR0:							.DATA.L H'fffff005
;DMAOPFLAG:						.DATA.L H'ffff8480
;DMAOPFLAG2:						.DATA.L H'ffff8484
;DMAread:						.DATA.L H'ffff8488
