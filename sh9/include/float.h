...
#define FLT_RADIX             2
#if defined(_SH2E)|defined(_SH3E)|((defined(_SH4)|defined(_SH4A)|defined(_SH2AFPU))&!defined(_RON))
#define FLT_ROUNDS            0
#define FLT_GUARD             0
#else
#define FLT_ROUNDS            1
...
#if defined(_SH2E)|defined(_SH3E)|((defined(_SH4)|defined(_SH4A)|defined(_SH2AFPU))&!defined(_DON))
...
#endif
#define FLT_EPSILON         FLT_POS_EPS
...
#define DBL_RADIX             2
#if (defined(_SH4)|defined(_SH4A)|defined(_SH2AFPU))&!defined(_RON)
#define DBL_ROUNDS            0
#define DBL_GUARD             0
#else
#define DBL_ROUNDS            1
...
#if (defined(_SH4)|defined(_SH4A)|defined(_SH2AFPU))&!defined(_DON)
...
#define DBL_NEG_EPS_EXP    (-53)
#endif
#define DBL_EPSILON         DBL_POS_EPS
...
#define FLT_EPSILON         DBL_EPSILON
#endif
...
#define LDBL_EPSILON        LDBL_POS_EPS
#else
