...
$(objdir)\LiveKnock.abs : LiveMap.o AltMaps.o LiveKnock.o idle.o # Ignition.o crank.o ,P_Ignition/39000,P_crank/3C000
	@echo Linking $^@ ...
	@optlnk	-NOLOGO -LISt -SHow=SY -FOrm=Absolute -start=P/2CC0,B/FFFF8480 -LIBrary=$(libname) -OUtput="$^@" $<
	@echo $(delimiter)	
